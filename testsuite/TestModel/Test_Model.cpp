...
int main (int argc, const char * argv[]) {
    ...
    if (!opt.optset("-seq")){
        std::cerr << "No sequence file defined in command line input\n Please check syntax.\n";
		//cout << usage << endl;
	}
	
	if (!opt.optset("-model")){
        std::cerr << "No model/models file defined in command line input\n Please check syntax.\n";
		//cout << usage << endl;
	}
    else{
        mods.importModels(opt.sopt("-model"),NULL);
    }
