...
//  StochHMM
//
//  Created by Paul Lott on 1/31/13.
//  Copyright (c) 2013 Korf Lab, Genome Center, UC Davis, Davis, CA. All rights reserved.
//

#ifndef StochHMM_newStochHMM_Usage_h
#define StochHMM_newStochHMM_Usage_h

#pragma mark Usage
const char usage[]  = "\n\
StochHMM - Stochastic Hidden Markov Model Framework (version 0.22 Beta - Development Branch) Date: January 31, 2013\n\
\n\
